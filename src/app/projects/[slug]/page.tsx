        ...
        <div className="relative w-full h-[70vh] min-h-125 flex items-end pb-16 pt-24 px-6 mt-16 md:mt-20">
          ...
          >
            <Image
              ...
              priority
            />
            {/* Dark/Blur Gradients - always dark to ensure text readability over image */}
          ...
          <div className="container max-w-5xl mx-auto relative z-10">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-slate-200 max-w-3xl font-medium leading-relaxed border-l-4 border-rose-400 pl-4 bg-slate-900/30 py-2">
