    ...
    >
      ...
      {hover && (
        <div className="absolute inset-0 z-0 opacity-0 hover:opacity-100 transition-opacity duration-700 pointer-events-none">
          <div className="absolute -inset-full top-0 bg-gradient-to-r from-transparent via-white/[0.02] to-transparent skew-x-12 animate-[shine_3s_ease-in-out_infinite]" />
        </div>
      )}
