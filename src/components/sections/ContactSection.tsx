...
const socialLinks = [
  {
    ...
    color: "hover:border-[var(--color-primary)]/50 hover:bg-[var(--color-primary)]/10",
    iconColor: "group-hover:text-[var(--color-primary)] text-[var(--color-body)]",
  ...
  return (
    <AnimatedSection id="contact" className="py-32 container mx-auto px-6">
      <AnimatedDiv className="max-w-4xl mx-auto">
        <div className="bg-[var(--color-canvas-elevated)] border border-[var(--color-hairline)] rounded-xl p-6 sm:p-10 md:p-16 relative overflow-hidden">
          {/* Background glow */}
          <div className="absolute -top-24 -right-24 w-64 h-64 bg-[var(--color-primary)]/10 rounded-full blur-3xl" />
          <div className="absolute -bottom-24 -left-24 w-64 h-64 bg-[var(--color-primary)]/5 rounded-full blur-3xl" />
          ...
          <div className="text-center mb-12 relative z-10">
            ...
            <p className="text-[var(--color-body)] text-lg max-w-2xl mx-auto">
          ...
          <div className="relative z-10 max-w-2xl mx-auto mb-12">
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  <label htmlFor="contact-name" className="block text-sm font-semibold text-[var(--color-ink)] mb-2">
                ...
                <div>
                  <label htmlFor="contact-email" className="block text-sm font-semibold text-[var(--color-ink)] mb-2">
              ...
              <div>
                <label htmlFor="contact-message" className="block text-sm font-semibold text-[var(--color-ink)] mb-2">
          ...
          <div className="relative z-10 flex items-center gap-4 max-w-2xl mx-auto mb-10">
            ...
            <span className="text-[var(--color-body)] text-sm font-medium whitespace-nowrap">
          ...
          <div className="relative z-10">
            ...
            {/* Response time */}
            <div className="mt-12 flex items-center justify-center gap-2 text-[var(--color-body)] text-sm">
