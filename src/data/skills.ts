  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        color: "#4CAF50",
        proficiency: "intermediate",
        usageContext: { id: "Analisis spasial kualitas air pesisir", en: "Coastal water quality spatial analysis" },
      },
      {
        name: "spatial analysis",
        icon: "spatialanalysis",
        color: "#2196F3",
        proficiency: "intermediate",
        usageContext: { id: "Analisis tren spatiotemporal kualitas air", en: "Water quality spatiotemporal trend analysis" },
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        color: "#9C27B0",
        proficiency: "intermediate",
        usageContext: { id: "Pengelompokan spectral kualitas air pesisir", en: "Coastal water quality spectral clustering" },
      },
      {
        name: "unsupervised learning",
        icon: "unsupervisedlearning",
        color: "#FF9800",
        proficiency: "intermediate",
        usageContext: { id: "Spectral clustering tanpa supervisi", en: "Unsupervised spectral clustering" },
      },
    ],
  },
  {
